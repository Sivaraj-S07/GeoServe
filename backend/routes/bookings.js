  ...
  try {
    ...
    try {
      ...
      history.push({
        ...
        changedAt: now,
        note:      `${simLabel}Confirmed by user. Payment mode: ${paymentMode}. Worker paid ₹${splitResult.split.workerPayout} (txn: ${splitResult.worker.transactionId}). Admin commission ₹${splitResult.split.adminCommission} (${splitResult.admin.commissionStatus}).`,
      });
