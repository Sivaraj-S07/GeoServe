...
const TYPE_CONFIG = {
  user_login:   { label: "User Login",   icon: "👤", color: "var(--primary)", bg: "var(--green-bg)", border: "var(--primary-border)" },
  worker_login: { label: "Worker Login", icon: "🔧", color: "var(--blue)", bg: "var(--blue-bg)", border: "#bfdbfe" },
...
function buildHistoryFromData(users, workers, bookings) {
  ...
  bookings.forEach(b => {
    ...
    entries.push({
      ...
      actorNameEn: b.userNameEn || b.userName || "",
...
function RoleBadge({ role }) {
  const map = {
    user:   { color: "var(--primary)", bg: "var(--green-bg)" },
    worker: { color: "var(--blue)", bg: "var(--blue-bg)" },
    ...
    <div style={{ position: "relative" }}>
      <button
        ...
        style={{
          ...
          background: rows.length === 0 ? "var(--green-soft)" : "var(--green)",
  ...
  return (
    <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,.55)",
      ...
      <div style={{ background: "white", borderRadius: 24, padding: "40px 36px", maxWidth: 460,
        ...
        <h2 style={{ fontSize: 20, fontWeight: 900, color: "#0c1a3d", margin: "0 0 10px" }}>
...
export default function HistoryPage({ onToast }) {
  ...
  const filtered = history.filter(e => {
    ...
    const matchSearch = !q ||
      ...
      (e.actorNameEn || "").toLowerCase().includes(q) ||
      (e.actorNameTa || "").toLowerCase().includes(q) ||
  ...
  return (
    <div className="anim-fade" style={{ padding:"28px 32px" }}>
      ...
      <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between",
        ...
        <div>
          <h1 style={{ fontSize: 28, fontWeight: 900, color: "#0c1a3d", margin: 0 }}>
            📋 Activity History
          </h1>
          ...
          {!loading && (
            <div style={{ marginTop: 8, display: "inline-flex", gap: 8, flexWrap: "wrap" }}>
              {dataSource === "derived" ? (
                ...
                <span style={{ display: "inline-flex", alignItems: "center", gap: 6,
                  background: "var(--green-bg)", border: "1px solid var(--primary-border)", borderRadius: 20,
                  padding: "3px 12px", fontSize: 11, fontWeight: 700, color: "var(--primary)" }}>
      ...
      <div style={{ display: "flex", gap: 14, flexWrap: "wrap", marginBottom: 24 }}>
        <SummaryPill icon="👤" label="User Logins"   count={counts.user_login}
          color="var(--primary)" bg="var(--green-bg)" border="var(--primary-border)" />
        <SummaryPill icon="🔧" label="Worker Logins" count={counts.worker_login}
          color="var(--blue)" bg="var(--blue-bg)" border="#bfdbfe" />
      ...
      {loading ? (
        ...
        <div style={{ ...card, padding: 64, textAlign: "center" }}>
          ...
          <h3 style={{ fontSize: 20, fontWeight: 700, color: "#0c1a3d", margin: "0 0 8px" }}>No history yet</h3>
            ...
            >
              ...
              <div style={{ minWidth: 0 }}>
                <div style={{ fontWeight: 700, fontSize: 13, color: "#0c1a3d",
                  ...
                  {getLocalizedName({ name: entry.actorName, nameEn: entry.actorNameEn }, i18n.language) || "—"}
                </div>
                  ...
                  return p <= totalPages ? (
                    <button key={p} onClick={() => setPage(p)}
                      style={{
                        ...
                        border: `1.5px solid ${p === safePage ? "var(--blue)" : "#e2e8f0"}`,
