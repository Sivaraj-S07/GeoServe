...
export default function ProfilePage({ onToast }) {
  ...
  const fallbackAvatar = `https://ui-avatars.com/api/?name=${encodeURIComponent(admin.name)}&background=2563eb&color=fff&size=160&bold=true`;
  ...
  const handleSaveInfo = async () => {
    ...
    try {
      ...
      onToast?.(t("profilePage.profileUpdated"), "success");
    } catch (e) {
  ...
  const handleChangePassword = async () => {
    ...
    try {
      ...
      onToast?.(t("profilePage.passwordUpdated"), "success");
  ...
  const TABS = [
    ...
    { id: "password", label: t("profilePage.changePassword"), icon: "lock" },
    { id: "security", label: t("adminProfile.title"), icon: "shield" },
  ];

  const sectionTitle = { fontFamily: "'Manrope',sans-serif", fontWeight: 800, fontSize: 18, marginBottom: 4, letterSpacing: -0.3, color: "var(--text)" };
  ...
  return (
    <div className="anim-fade" style={{ maxWidth: 880, margin: "0 auto", padding: "28px 24px 48px" }}>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 28 }}>
        ...
        <div>
          <h1 style={{ fontFamily: "'Manrope',sans-serif", fontWeight: 800, fontSize: 24, margin: 0, letterSpacing: -0.5, color: "var(--text)" }}>
            My Account
          </h1>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "230px 1fr", gap: 20, alignItems: "start" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          ...
          <div className="card" style={{ padding: 0, overflow: "hidden" }}>
            {/* Banner gradient */}
            <div style={{ height: 56, background: "linear-gradient(135deg, var(--primary) 0%, #7c3aed 50%, #a78bfa 100%)" }} />
            ...
            <div style={{ padding: "0 20px 20px", textAlign: "center" }}>
              ...
              <div style={{ fontFamily: "'Manrope',sans-serif", fontWeight: 700, fontSize: 15, marginBottom: 2, color: "var(--text)" }}>
                {admin.name}
              </div>
              ...
              <span style={{
                ...
                fontFamily: "'Manrope',sans-serif", textTransform: "uppercase", letterSpacing: 0.5,
              }}>
          ...
          {tab === "info" && (
            <>
              ...
              <div style={{
                ...
                />
                <div style={{ flex: 1 }}>
                  <div style={{ fontSize: 13, fontWeight: 600, marginBottom: 8, color: "var(--text-secondary)", fontFamily: "'Manrope',sans-serif" }}>
                    Profile Photo
                  </div>
