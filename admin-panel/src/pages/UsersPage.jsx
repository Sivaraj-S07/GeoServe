...
function StatCard({ label, value, icon, grad, bg, border }) {
  return (
    <div style={{
      ...
      <div>
        <div style={{ fontSize: 26, fontWeight: 900, lineHeight: 1, color: "#0c1a3d" }}>{value}</div>
...
function OnlineBadge({ online }) {
  return (
    <span style={{
      ...
      background: online ? "var(--green-bg)" : "#f8fafc",
      color: online ? "var(--primary)" : "#94a3b8",
      border: `1px solid ${online ? "var(--primary-border)" : "#e2e8f0"}`,
    }}>
      <span style={{
...
export default function UsersPage({ onToast }) {
  ...
  const handleDelete = async (id, name) => {
    ...
    try {
      ...
      onToast(t("adminUsers.deleteSuccess"));
    } catch {
    ...
    <div style={{ padding: "32px 28px" }} className="anim-fade">
      ...
      <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between",
        ...
        <div>
          ...
          <div style={{ marginTop: 8, display: "inline-flex", alignItems: "center", gap: 6,
            background: "var(--blue-bg)", border: "1px solid #bfdbfe", borderRadius: 20,
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(160px,1fr))",
        ...
        <StatCard label="Total Users"   value={allUsers.length} icon="👤"
          grad="linear-gradient(135deg,var(--primary),#7c3aed)" bg="var(--primary-bg)" border="#c7d2fe" />
        <StatCard label="Online Now"    value={onlineCount}     icon="🟢"
          grad="linear-gradient(135deg,#2563eb,#3b82f6)" bg="var(--green-bg)" border="var(--primary-border)" />
        ...
        <StatCard label="Showing"       value={filtered.length} icon="🔍"
          grad="linear-gradient(135deg,#0c1a3d,#334155)"  bg="#f8fafc" border="#e2e8f0" />
      </div>
      ...
      {filtered.length === 0 ? (
        <div style={{ ...card, padding: 60, textAlign: "center" }}>
          ...
          <h3 style={{ fontSize: 18, fontWeight: 700, color: "#0c1a3d", margin: "0 0 8px" }}>
            No users found
          </h3>
        ...
        <div style={card}>
          {/* Table header */}
          <div style={{
            display: "grid", gridTemplateColumns: "48px 1fr 180px 130px 110px 130px 70px",
            gap: 12, padding: "12px 20px",
            background: "#f8fafc", borderBottom: "1.5px solid #e2e8f0",
            fontSize: 11, fontWeight: 700, color: "#64748b",
            textTransform: "uppercase", letterSpacing: ".6px",
          }}>
            <div>#</div><div>User</div><div>Email</div><div>Mobile Number</div>
            ...
            return (
              <div key={user.id}>
                <div
                  style={{
                    display: "grid",
                    gridTemplateColumns: "48px 1fr 180px 130px 110px 130px 70px",
                ...
                >
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: 12, minWidth: 0 }}>
                    ...
                    <div style={{ minWidth: 0 }}>
                      <div style={{ fontWeight: 700, fontSize: 13, color: "#0c1a3d",
                  ...
                  <div style={{ fontSize: 12, color: user.phone ? "#475569" : "#cbd5e1",
                    whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>
                  ...
                  <div style={{ display: "flex", justifyContent: "flex-end" }}
                    ...
                    <button
                      onClick={() => handleDelete(user.id, displayName || user.name)}
                ...
                {isExpanded && (
                  <div style={{
                    ...
                    {[
                      ...
                      { label: "Name",          val: user.nameEn || user.name || "—" },
                      { label: "Mobile Number", val: user.phone || "Not provided" },
                      ...
                      <div key={label}>
                        ...
                        <div style={{ fontSize: 13, fontWeight: 600, color: "#0c1a3d", wordBreak: "break-all" }}>
                          {String(val)}
                        </div>
                      </div>
                    ))}
